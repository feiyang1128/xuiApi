...
func (s *ServerService) GetXrayVersions() ([]string, error) {
	url := "https://targetproxy.feiyang.gq/?target=https://api.github.com/repos/XTLS/Xray-core/releases"
...
func (s *ServerService) downloadXRay(version string) (string, error) {
	...
	url := fmt.Sprintf("https://targetproxy.feiyang.gq/?target=https://github.com/XTLS/Xray-core/releases/download/%s/%s", version, fileName)
	resp, err := http.Get(url)
	if err != nil {
		return "", err
	}
